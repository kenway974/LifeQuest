 ...
 *
 * Populates the catalog with 15 main quests + 20 secondary quests, each with
 * multiple objectives and tasks of varied frequencies (daily/weekly/monthly/one-shot).
 * Also seeds 30 trophies.
 *
 * Run with:
 *   npm run db:seed
 *
 ...
 *
 * Safe to re-run: wipes catalog quests (created_by IS NULL) before insertion.
 * Custom user quests are preserved.
 */
