...
export const LIFE_QUESTS: QuestModule = {
  quests: [
      ...
      objectives: [
        {
          ...
          tasks: [
            ...
            { title: "Tenir un journal de ses envies de stimulation", xp_reward: 15 },
          ],
        },
        {
          ...
          tasks: [
            { title: "Planifier et préparer son weekend détox", xp_reward: 15, frequency_days: 365 },
            { title: "Tenir le weekend sans retomber dans les stimulations", xp_reward: 50, frequency_days: 365 },
            { title: "Écrire un bilan de l'expérience", xp_reward: 20, frequency_days: 365 },
          ],
        },
      ],
    },
      ...
      objectives: [
        {
          ...
          tasks: [
            { title: "Cocher sa journée sans rechute", xp_reward: 20 },
            { title: "Faire 10 min d'exercice physique en cas d'envie", xp_reward: 15 },
            { title: "Lire un témoignage de motivation (NoFap/forum)", xp_reward: 10, is_optional: true },
          ],
        },
        {
          ...
          tasks: [
            { title: "Lister ses 3 principaux déclencheurs", xp_reward: 20, frequency_days: 365 },
            { title: "Pratiquer une activité de remplacement lors d'une envie", xp_reward: 25 },
          ],
        },
      ],
    },
      ...
      objectives: [
        {
          ...
          tasks: [
            ...
            { title: "Faire quelque chose de créatif ou physique à la place", xp_reward: 15 },
          ],
        },
        {
          ...
          tasks: [
            { title: "Calculer les heures récupérées dans la semaine", xp_reward: 20, frequency_days: 7 },
            { title: "Avancer sur un projet personnel avec ces heures", xp_reward: 30, frequency_days: 7 },
          ],
        },
      ],
    },
      ...
      objectives: [
        {
          ...
          tasks: [
            ...
            { title: "Pratiquer 3 respirations profondes lors d'une envie", xp_reward: 10 },
            { title: "Appeler ou écrire à un proche de soutien lors d'une crise", xp_reward: 15, is_optional: true },
          ],
        },
        {
          ...
          tasks: [
            { title: "Écrire son bilan hebdomadaire de bénéfices", xp_reward: 40, frequency_days: 7 },
            { title: "Calculer l'argent économisé depuis l'arrêt", xp_reward: 20, frequency_days: 7 },
          ],
        },
      ],
    },
      ...
      objectives: [
        {
          ...
          tasks: [
            ...
            { title: "Inscrire dans son journal une envie d'achat refusée", xp_reward: 10 },
            { title: "Appliquer la règle des 48 h pour un achat potentiel", xp_reward: 20 },
          ],
        },
        {
          ...
          tasks: [
            { title: "Lister ses 3 situations déclencheuses d'achat", xp_reward: 30, frequency_days: 365 },
            { title: "Écrire une stratégie de remplacement pour chaque déclencheur", xp_reward: 30, frequency_days: 365 },
          ],
        },
      ],
    },
      ...
      objectives: [
        {
          ...
          tasks: [
            { title: "Relever son temps d'écran quotidien", xp_reward: 10 },
            { title: "Respecter la limite fixée aujourd'hui", xp_reward: 20 },
            { title: "Faire une activité hors écran en fin de journée", xp_reward: 15 },
          ],
        },
        {
          ...
          tasks: [
            { title: "Tenir une plage de 2 h sans écran dans la journée", xp_reward: 25 },
            { title: "Repas pris sans téléphone posé sur la table", xp_reward: 15 },
          ],
        },
      ],
    },
      ...
      objectives: [
        {
          ...
          tasks: [
            ...
            { title: "Préparer son repas du lendemain la veille", xp_reward: 20 },
            { title: "Planifier ses repas de la semaine le dimanche", xp_reward: 25, frequency_days: 7 },
          ],
        },
        {
          ...
          tasks: [
            { title: "Tester une nouvelle recette rapide cette semaine", xp_reward: 30, frequency_days: 7 },
            { title: "Ajouter la recette à son répertoire personnel", xp_reward: 15, frequency_days: 7 },
          ],
        },
      ],
    },
      ...
      objectives: [
        {
          ...
          tasks: [
            { title: "Auditer et désactiver les notifications parasites", xp_reward: 30, frequency_days: 365 },
            { title: "Consulter ses messages à des heures fixes uniquement", xp_reward: 20 },
            { title: "Journée sans interruption numérique involontaire", xp_reward: 15 },
          ],
        },
        {
          ...
          tasks: [
            { title: "Remplir son journal de concentration du soir", xp_reward: 15 },
            { title: "Identifier une tâche accomplie sans interruption", xp_reward: 20 },
          ],
        },
      ],
    },
      ...
      objectives: [
        {
          ...
          tasks: [
            { title: "Désencombrer la zone du jour", xp_reward: 15 },
            { title: "Sortir immédiatement les objets à donner ou jeter", xp_reward: 10 },
            { title: "Photographier la zone avant/après", xp_reward: 10, is_optional: true },
          ],
        },
        {
          ...
          stat_impacts: { calme: 2, discipline: 2 },
          tasks: [
            { title: "Déposer un sac de dons cette semaine", xp_reward: 40, frequency_days: 7 },
          ],
        },
      ],
    },
      ...
      objectives: [
        {
          ...
          tasks: [
            { title: "Identifier et retirer l'objet du jour", xp_reward: 15 },
            { title: "Consigner l'objet dans son journal minimaliste", xp_reward: 10, is_optional: true },
          ],
        },
        {
          ...
          stat_impacts: { calme: 2, discipline: 2 },
          tasks: [
            { title: "Écrire son bilan de 30 jours et sa nouvelle règle d'achat", xp_reward: 60, frequency_days: 365 },
          ],
        },
      ],
    },

    {
      ...
      description:
        "En 14 jours, ramène ta garde-robe à l'essentiel : une collection restreinte de vêtements que tu adores et qui se combinent tous. Fini le manque d'inspiration vestimentaire.",
      type: "secondary",
      difficulty: "medium",
      duration_days: 14,
      xp_reward: 420,
      objectives: [
        {
          ...
          description:
            "Sortir tous ses vêtements, tester chaque pièce selon le critère de l'enthousiasme, et conserver maximum 40 pièces.",
          xp_reward: 250,
          stat_impacts: { calme: 4, discipline: 3 },
          tasks: [
            { title: "Vider entièrement son placard et tout étaler", xp_reward: 20, frequency_days: 365 },
            { title: "Trier chaque vêtement en garder/donner/jeter", xp_reward: 30, frequency_days: 365 },
            { title: "Emballer les vêtements à donner et les sortir de chez soi", xp_reward: 20, frequency_days: 365 },
          ],
        },
        {
          ...
          stat_impacts: { calme: 2, discipline: 2 },
          tasks: [
            { title: "Planifier ses tenues de la semaine", xp_reward: 25, frequency_days: 7 },
            { title: "Journée habillée uniquement avec sa capsule", xp_reward: 15 },
          ],
        },
      ],
    },
      ...
      objectives: [
        {
          ...
          tasks: [
            { title: "Pratiquer le geste zéro déchet du jour", xp_reward: 15 },
            { title: "Analyser ses déchets de la semaine et identifier une réduction possible", xp_reward: 30, frequency_days: 7 },
          ],
        },
        {
          ...
          stat_impacts: { calme: 2, discipline: 2 },
          tasks: [
            { title: "Peser ou estimer le volume de ses poubelles en début de défi", xp_reward: 25, frequency_days: 365 },
            { title: "Peser ou estimer le volume de ses poubelles en fin de défi", xp_reward: 25, frequency_days: 365 },
            { title: "Écrire son bilan de réduction des déchets", xp_reward: 40, frequency_days: 365 },
          ],
        },
      ],
    },
      ...
      objectives: [
        {
          ...
          tasks: [
            { title: "Lister les objets à réparer chez soi", xp_reward: 20, frequency_days: 365 },
            { title: "Réparer ou faire réparer un objet cette semaine", xp_reward: 50, frequency_days: 7 },
            { title: "Regarder un tutoriel de réparation pour un objet spécifique", xp_reward: 15, is_optional: true },
          ],
        },
        {
          ...
          stat_impacts: { discipline: 2, calme: 2 },
          tasks: [
            { title: "Calculer les économies réalisées grâce à la réparation", xp_reward: 40, frequency_days: 365 },
            { title: "Écrire ce que cette habitude change dans son rapport aux objets", xp_reward: 40, frequency_days: 365 },
          ],
        },
      ],
    },
      ...
      objectives: [
        {
          ...
          tasks: [
            { title: "Supprimer ou archiver tous les mails de plus de 3 mois", xp_reward: 30, frequency_days: 365 },
            { title: "Se désabonner de 10 newsletters non lues", xp_reward: 20, frequency_days: 365 },
            { title: "Atteindre l'inbox zéro", xp_reward: 40, frequency_days: 365 },
          ],
        },
        {
          ...
          stat_impacts: { focus: 3, calme: 2 },
          tasks: [
            { title: "Vider le dossier Téléchargements", xp_reward: 20, frequency_days: 365 },
            { title: "Supprimer les doublons et mauvaises photos de son téléphone", xp_reward: 25, frequency_days: 365 },
            { title: "Désinstaller les applications non utilisées depuis 3 mois", xp_reward: 20, frequency_days: 365 },
          ],
        },
      ],
    },
      ...
      objectives: [
        {
          ...
          tasks: [
            { title: "Planifier sa nouvelle expérience de la semaine", xp_reward: 20, frequency_days: 7 },
            { title: "Réaliser l'expérience choisie", xp_reward: 50, frequency_days: 7 },
            { title: "Écrire 3 phrases sur ce que cette expérience t'a apporté", xp_reward: 20, frequency_days: 7 },
          ],
        },
        {
          ...
          tasks: [
            { title: "Écrire sa liste de 10 nouvelles expériences", xp_reward: 30, frequency_days: 365 },
            { title: "Partager cette liste avec quelqu'un pour s'engager", xp_reward: 20, frequency_days: 365, is_optional: true },
          ],
        },
      ],
    },
      ...
      objectives: [
        {
          ...
          tasks: [
            { title: "Identifier et planifier sa première microaventure", xp_reward: 20, frequency_days: 365 },
            { title: "Réaliser une microaventure dans la région", xp_reward: 80, frequency_days: 14 },
            { title: "Prendre des photos ou tenir un journal de l'aventure", xp_reward: 15, frequency_days: 14, is_optional: true },
          ],
        },
        {
          ...
          tasks: [
            { title: "Créer sa carte de la région", xp_reward: 25, frequency_days: 365 },
            { title: "Ajouter un lieu découvert sur sa carte", xp_reward: 20, frequency_days: 7 },
          ],
        },
      ],
    },
      ...
      objectives: [
        {
          ...
          tasks: [
            { title: "Choisir et préparer sa randonnée de la semaine", xp_reward: 20, frequency_days: 7 },
            { title: "Réaliser la randonnée prévue", xp_reward: 60, frequency_days: 7 },
            { title: "Inviter quelqu'un à randonner avec soi", xp_reward: 20, frequency_days: 7, is_optional: true },
          ],
        },
        {
          ...
          tasks: [
            { title: "Comparer sa randonnée de cette semaine à celle de la précédente", xp_reward: 20, frequency_days: 7 },
            { title: "Noter ses performances dans un carnet de randonnée", xp_reward: 15, frequency_days: 7 },
          ],
        },
      ],
    },
      ...
      objectives: [
        {
          ...
          tasks: [
            { title: "Choisir son rêve de bucket list et l'écrire", xp_reward: 20, frequency_days: 365 },
            { title: "Dresser la liste des étapes concrètes pour le réaliser", xp_reward: 30, frequency_days: 365 },
            { title: "Accomplir l'expérience", xp_reward: 100, frequency_days: 365 },
          ],
        },
        {
          ...
          tasks: [
            { title: "Écrire un récit détaillé de l'expérience", xp_reward: 50, frequency_days: 365 },
            { title: "Partager cette expérience avec au moins une personne", xp_reward: 30, frequency_days: 365 },
            { title: "Mettre à jour sa bucket list avec un nouvel item", xp_reward: 20, frequency_days: 365, is_optional: true },
          ],
        },
      ],
    },
      ...
      objectives: [
        {
          ...
          tasks: [
            { title: "S'inscrire à une formation premiers secours (PSC1 ou équivalent)", xp_reward: 30, frequency_days: 365 },
            { title: "Visionner et réviser un geste de secours", xp_reward: 15 },
            { title: "Pratiquer la RCP sur mannequin ou coussin", xp_reward: 25, frequency_days: 365 },
          ],
        },
        {
          ...
          tasks: [
            { title: "Réussir la formation ou passer le quiz de validation", xp_reward: 50, frequency_days: 365 },
            { title: "Constituer une trousse de secours complète à la maison", xp_reward: 30, frequency_days: 365 },
          ],
        },
      ],
    },

    {
      ...
      description:
        "En 30 jours, cuisine 10 plats fondamentaux que tout adulte devrait savoir faire : oeufs brouillés, pâtes maison, poulet rôti, soupe, vinaigrette… Deviens autonome en cuisine.",
      type: "secondary",
      difficulty: "easy",
      duration_days: 30,
      xp_reward: 450,
      objectives: [
        {
          ...
          tasks: [
            { title: "Cuisiner le plat de base de la séquence", xp_reward: 30, frequency_days: 3 },
            { title: "Évaluer son résultat et noter les points d'amélioration", xp_reward: 15, frequency_days: 3 },
          ],
        },
        {
          ...
          stat_impacts: { discipline: 2, creativite: 2 },
          tasks: [
            { title: "Refaire un plat de mémoire sans consulter la recette", xp_reward: 30, frequency_days: 3 },
          ],
        },
      ],
    },
      ...
      objectives: [
        {
          ...
          stat_impacts: { calme: 4, discipline: 3 },
          tasks: [
            { title: "Choisir sa plante ou graine et préparer le pot ou le carré", xp_reward: 20, frequency_days: 365 },
            { title: "Arroser et observer sa plante aujourd'hui", xp_reward: 10 },
            { title: "Prendre une photo de l'évolution hebdomadaire", xp_reward: 10, frequency_days: 7, is_optional: true },
          ],
        },
        {
          ...
          tasks: [
            { title: "Écrire une entrée dans son journal de jardin cette semaine", xp_reward: 15, frequency_days: 7 },
            { title: "Récolter sa première production ou documenter la floraison", xp_reward: 40, frequency_days: 365 },
          ],
        },
      ],
    },
      ...
      objectives: [
        {
          ...
          tasks: [
            { title: "Identifier trois projets de bricolage à réaliser chez soi", xp_reward: 20, frequency_days: 365 },
            { title: "Se procurer les outils et fournitures nécessaires", xp_reward: 20, frequency_days: 365 },
            { title: "Réaliser un projet de bricolage cette semaine", xp_reward: 60, frequency_days: 7 },
          ],
        },
        {
          ...
          stat_impacts: { discipline: 2, creativite: 2 },
          tasks: [
            { title: "Lister les outils essentiels à posséder", xp_reward: 20, frequency_days: 365 },
            { title: "Acheter ou récupérer les outils manquants", xp_reward: 30, frequency_days: 365 },
            { title: "Ranger et organiser sa boîte à outils", xp_reward: 20, frequency_days: 365 },
          ],
        },
      ],
    },
  ...
  meta: {
    ...
    "Réduire son temps d'écran de moitié": {
      ...
      summary:
        "En 21 jours, divise par deux ton temps d'écran récréatif et reconquiers des heures pour ce qui te tient vraiment à coeur.",
    },
    ...
    "La garde-robe capsule": {
      ...
      context: ["reset", "improve"],
      summary:
        "Réduis ta garde-robe à l'essentiel en 14 jours et habille-toi avec ce que tu adores vraiment.",
    },
